...
//fill data into table
        function loadTable(page,size,query) {
            page = page - 1;
            students = new Array();
          var data = httpRequest("/studenthasevent/findAll?page="+page+"&size="+size+query,"GET");
...
//class room name
        ...
        function loadForm() {
            stuevent = new Object();
            oldstuevent = null;     //form eka load wenakota old object ekak nathi nisa old object = null

            //fill data in to combo box


            fillCombo(cmbStudentId,"",students,"cname","");
